...
public:
	 ...
	 */
	explicit DynamicBCTree (Graph& G, bool not_connected = false) : DynamicBCTree(G, nullptr, not_connected) {}
	 ...
	 */
	explicit DynamicBCTree (Graph& G, node vG, bool not_connected = false) : BCTree(G,vG, not_connected) { init(); }
	//! @}
