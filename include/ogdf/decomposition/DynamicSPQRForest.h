...
public:
	 ...
	 */
	explicit DynamicSPQRForest(Graph& G, bool not_connected = false) : DynamicSPQRForest(G, nullptr, not_connected) {}
	 ...
	 * 	Otherwise, only the connected component of G.firstNode() will be processed.
	 */
	DynamicSPQRForest(Graph& G, node vG, bool not_connected = false) : DynamicBCTree(G, vG, not_connected) { init(); }
